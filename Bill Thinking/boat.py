...
class Boat:
    ...
    def kinematics(self,dt,model):
        ...
        #sail torque aspect
        Ts = -self.q*self.strength_Main*sin(self.main_angle-model.wind.windheading)*math.sqrt(model.wind.windspeed)
        Ts = self.q*self.strength_Jib*sin(self.jib_angle-model.wind.windheading)*math.sqrt(model.wind.windspeed)
